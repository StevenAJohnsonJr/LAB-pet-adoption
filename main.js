const pets = [
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://play-lh.googleusercontent.com/3lSIao0O6u04909exLv582FJRLwqHUaSKtNRUyOT45XUxmho7jIh6zIFKD6tfKF5ODo",
    favorite: true,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTly2jtPLVrlEBddddwwYsauSY3D9nkj1RO1A&usqp=CAU",
    favorite: false,
  },
  {
    id: 17,
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://store-images.s-microsoft.com/image/apps.12340.13707417064355662.7101e27d-b196-48d4-856b-d3018775f70b.503dc229-59c1-484f-988d-851c2068aa56?mode=scale&q=90&h=1080&w=1920",
    favorite: true,
  },
  {
    id: 19,
    ...
    type: "dog",
    imageUrl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ40rEFgnyXSEcsjnL54o4ZeoY3F0geOQbUIA&usqp=CAU",
    favorite: false,
  },
  {
    id: 20,
    ...
    type: "cat",
    imageUrl:
      "https://i.pinimg.com/736x/3f/2c/44/3f2c44568b8ef84fb16f4042c2950d5f.jpg",
    favorite: false,
  },
  {
    id: 21,
    ...
    type: "dino",
    imageUrl:
      "https://assets.nintendo.com/image/upload/f_auto/q_auto/dpr_2.625/c_scale,w_400/ncom/en_US/games/switch/s/super-dino-switch/description_image",
    favorite: false,
  },
  {
    id: 22,
    ...
    type: "cat",
    imageUrl:
      "https://preview.redd.it/02g1pfot5ds41.jpg?width=640&crop=smart&auto=webp&s=c1f4b571f5630233d45135d5c256fa6cbbeae128",
    favorite: false,
  },
  {
    id: 23,
  ...
  },
  {
    ...
    type: "cat",
    imageUrl:
      "https://www.rover.com/blog/wp-content/uploads/2019/06/cat-2934720_1920.jpg",
    favorite: false,
  },
  {
    id: 26,
  ...
  },
  {
    ...
    type: "dino",
    imageUrl:
      "https://pbs.twimg.com/profile_images/1488679573998948356/1wjxxmEB_400x400.png",
    favorite: false,
  },
];
...
const renderToDom = (divId, htmlToRender) => {
  const targetDivId = document.querySelector(divId);
  targetDivId.innerHTML = htmlToRender;
};

const cardToDom = (petsArray) => {
  let html = "";
  for (const pet of petsArray) {
    html += `<div class="card" style="width: 18rem;">
      ...
      <div class="card-body">
        ...
        <button class="btn btn-danger" id="delete--${pet.petId}">Delete</button>
        
      </div>
    </div>`;
  }
  renderToDom("#taco", html);
};
// cardToDom(pets)

const petFilter = (petsArray, petType) => {
  const arrayOfPets = [];
  for (const pet of petsArray) {
    if (pet.type === petType) arrayOfPets.push(pet);
  }
  return arrayOfPets;
};
const viewAll = document.querySelector("#viewAll");
const doggie = document.querySelector("#doggie");
const kitties = document.querySelector("#kitties");
const dinos = document.querySelector("#dinos");

doggie.addEventListener("click", () => {
  const dogFilter = petFilter(pets, "dog");
  cardToDom(dogFilter);
});

kitties.addEventListener("click", () => {
  const catFilter = petFilter(pets, "cat");
  cardToDom(catFilter);
});

dinos.addEventListener("click", () => {
  const dinoFilter = petFilter(pets, "dino");
  cardToDom(dinoFilter);
});
...
const submitButton = document.querySelector("#addPet");
...
const petDiv = document.querySelector("#petDiv");

petDiv.addEventListener("click", (event) => {
  if (event.target.petId.includes("delete")) {
    const [, petId] = event.target.petId.split("--");
    const indexOfPet = pets.findIndex((object) => object.petId === Number(petId));
